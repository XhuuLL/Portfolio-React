  ...
  return (
    <footer className="mt-32 w-full border-t border-zinc-800 py-10 px-6 md:px-12">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        {/* Sisi Kiri: Copyright & Info (Sesuai Gambar) */}
        ...
        {/* Sisi Kanan: Ikon Sosial Media (Minimalis) */}
        <div className="flex items-center gap-5 order-1 md:order-2 text-zinc-400">
          ...
          <a href="https://x.com/MasFatkhul" className="hover:text-white transition-colors">
