...
const cardTexturePath = "/portofolio/assets/card.png"; 
    ...
    <div className="lanyard-wrapper">
      ...
      >
        ...
        <Physics gravity={gravity} timeStep={1 / 60}>
          {/* Suspense mencegah blackscreen saat loading gambar */}
...
function Band({ maxSpeed = 50, minSpeed = 0 }) {
  ...
  const lanyardTexture = useTexture(lanyardPath);

  // Perbaikan arah gambar agar tidak terbalik
  useLayoutEffect(() => {
    if (cardTexture) {
    ...
    <>
      <group position={[0, 4, 0]}>
        ...
        >
          ...
          >
            {/* 1. BODY KARTU (Dasar Hitam) */}
            <RoundedBox args={[1.6, 2.25, 0.05]} radius={0.1} smoothness={4}>
              <meshStandardMaterial color="#000000" metalness={0.5} roughness={0.5} />
            </RoundedBox>

            {/* 2. LAYER FOTO (Ditempel Pas di Depan) */}
